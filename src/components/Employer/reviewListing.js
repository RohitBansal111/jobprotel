                    ...
                    <div className="review-listing-action">
                         {
                             showRejectedView ?
                              <>
                              {
                                   ...
                                   <button type="button" onClick={handleAcceptInvitation} className="btn btn-primary mr-2">Accept</button>
                                   :
                                   <button type="button" onClick={handleChatNow} className="btn btn-primary mr-2"><i className="fa fa-comments mr-2"></i> Chat Now</button>
                                   }
                                   <button type="button" onClick={handleRejected} className="btn btn-reject">Reject</button>
                              </>
                              :
                              <button type="button" onClick={handleRejected} className="btn btn-reject">Rejected</button>
                         }
                    </div>
               </div>
