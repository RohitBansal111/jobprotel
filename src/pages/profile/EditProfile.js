...
const  interestedArea = [
     {id: '1',text: 'Book Reading'},
     {id: '2',text: 'Playing Game'},
     {id: '3',text: 'Learning'},
     {id: '4',text: 'Traveling'},
     {id: '5',text: 'AWS-admin'},
]
                                                       ...
                                                       <div className="profile-edit-info-list">
                                                            <div className="form-field-group">
                                                                 ...
                                                                 <div className="form-field flex100">
                                                                      <Field name="intrestedArea" label="Interested area" suggestions={interestedArea} placeholder="Enter interested area" component={RenderTagField} />
                                                                 </div>
                                                                 <div className="form-field flex50">
