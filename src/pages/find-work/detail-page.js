                  ...
                  <div className='col-12 col-md-9'>
                    <div className='details-card'>
                        <div className='head43'>
                          <h2>Fullstack project assessment & advice <span>Posted 8 hours ago</span></h2>
                        ...
                        <div className='job-description'>
                            <p>I need help with the html and css for the attached image.</p>
                            <p>The coding must be responsive, so even on a mobile phone the 2 images overlap.</p>
                            <p>Should be separate images.</p>
                            <p>The button should be perfectly centered horizontally and vertically.</p>
                            <p>If needed on screens under 450px, we can remove order and text decorate underline.</p>
                            <p>**I do not need coding for the top 3 lines of text:</p>
                            <p>Beautiful woven collection of classic motifs: buffalo plaid, paisley, ticking stripes & more.</p>
                        </div>
                  ...
                  <div className='col-12 col-md-3'>
                    <div className='details-right-sidebar'>
                        <div className='post-action'>
                          ...
                          <button type="button" className='btn btn-primary-outline'>Saved Job</button>
                        </div>
